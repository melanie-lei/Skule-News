...
class LocalizationString {
  ...
  static String featured = 'Featured'.tr();

  static String forYou = 'For you'.tr();
  ...
  static String loginOrSignup = 'Login or signup'.tr();
  static String loginViaEmail = 'Login via email'.tr();
  static String loginViaPhone = 'Login via phone'.tr();

  static String welcome = 'Welcome'.tr();

  static String welcomeSubtitleMsg = 'Discover best articles here'.tr();

  static String letsGetStarted = 'Let\'s get started'.tr();
  static String loginToTips = 'Login to our top picks for you!'.tr();
  static String continueAsGuest = 'Continue as Guest'.tr();
  ...
  static String activate = 'Activated'.tr();
  static String deactivated = 'De-Activated'.tr();

  static String signUpCaps = 'SIGN UP'.tr();
  ...
  static String packageAdded = 'Package added successfully'.tr();
  static String packageUpdated = 'Package updated successfully'.tr();
  ...
  static String deActivateBlog = 'De-Activate Article'.tr();
  ...
  static String addPackage = 'Add Package'.tr();
  static String packages = 'Packages'.tr();
  static String packageName = 'Package Name'.tr();
  static String packagePrice = 'Package Price (in USD)'.tr();
  ...
  static String contentType = 'Content Type'.tr();
  ...
  static String tryForFreeAndSubscribe = 'Try for free & Subscribe'.tr();
  static String unlock = 'Unlock'.tr();

  static String logout = 'Log Out'.tr();
  static String changePwd = 'Change Password'.tr();
  static String changePwdMessage = 'Enter your new password'.tr();

  static String enterAddress = 'Enter address details'.tr();

  static String shippingMethod = 'Shipping Method'.tr();
  ...
  static String bookmarked = 'Bookmarked'.tr();

  static String settings = 'Settings'.tr();
  static String settingsSaved = 'Settings Saved'.tr();

  static String supportRequest = 'Support Request'.tr();
  static String supportId = 'Support Id :'.tr();

  static String report = 'Report'.tr();
  static String replied = 'Replied'.tr();

  static String markAsFeatured = 'Mark as Featured'.tr();
  static String removeFromFeatured = 'Remove from Featured'.tr();

  static String markAsPremium = 'Mark as Premium'.tr();
  static String removeFromPremium = 'Remove from Premium'.tr();
  ...
  static String isPremium = 'Is premium'.tr();
  ...
  static String wantToAddToFeatured =
      'Do you want to featured this article?'.tr();
