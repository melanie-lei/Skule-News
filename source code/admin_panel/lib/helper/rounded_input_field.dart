...
class _DropdownFiledState extends State<DropdownFiled> {
  ...
  void initState() {
    ...
    cornerRadius = widget.cornerRadius;
    // cursorColor = widget.cursorColor ?? Theme.of(context).primaryColorDark;
    // textStyle = widget.textStyle ?? Theme.of(context).textTheme.bodyLarge!;
    // hintTextStyle = widget.hintTextStyle ?? Theme.of(context).textTheme.bodyMedium!;
                    ...
                    children: [
                      Expanded(
                        child: Align(
                          ...
                          child: Text(widget.text ?? hintText ?? '',
                              style: widget.text == null
