...
class NewsFullDetail extends StatefulWidget {
  ...
  const NewsFullDetail({Key? key, required this.model}) : super(key: key);
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                        '${sourceController.reporter.value?.totalPosts ?? 0} ${LocalizationString.posts.toLowerCase()}',
        ...
        builder: (ctx) {
          return Column(
            children: [
              ...
              SizedBox(
                height:
                    (min(3, newsDetailController.similarNews.length) * 160) +
                        (min(3, newsDetailController.similarNews.length) * 10),
